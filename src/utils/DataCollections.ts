...
export const DEMONDOSZPOD: CardData = {imageLocation: "/images/Sejtelmes Sikkasztók/Semleges Gyilkos/DemonikusDoszpod.png", faction: Faction.NEUTRAL, character: Character.DEMONDOSZPOD, abilities: [{ abilityType: AbilityType.DEMOGORGON_KILL, usageCountTotal: 0 }], actionDescription: DEMON_DOSZPOD, effects: [], isAlive: true, demonDoszpodDeathCount: 0};
