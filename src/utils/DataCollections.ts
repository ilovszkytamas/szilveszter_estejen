...
export const FANATIKUS: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Sejtelmes Sikkasztók/Fanatikus/Fanatikus.png`, faction: Faction.NEUTRAL, character: Character.FANATIKUS, abilities: [{ abilityType: AbilityType.FANATIKUS_KILL, usageCountTotal: 0 }], actionDescription: FANATIKUS_ACTION, effects: [], isAlive: true};
export const KOTYVASZTÓ1: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Sejtelmes Sikkasztók/Kotyvasztó-Alkimista/Kotyvasztó_Alkimista.png`, faction: Faction.NEUTRAL, character: Character.KOTYVASZTÓ1, abilities: [{ abilityType: AbilityType.ALKIMISTA_BOMBA, usageCountTotal: 0 }, { abilityType: AbilityType.ALKIMISTA_GYOGYITAL, usageCountTotal: 0 }, { abilityType: AbilityType.ALKIMISTA_SZIKLABOR, usageCountTotal: 0 }], actionDescription: ALKIMISTA_ACTION, effects: [], isAlive: true};
export const KOTYVASZTÓ2: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Sejtelmes Sikkasztók/Kotyvasztó-Alkimista/Kotyvasztó_Alkimista2.png`, faction: Faction.NEUTRAL, character: Character.KOTYVASZTÓ2, abilities: [{ abilityType: AbilityType.ALKIMISTA_BOMBA, usageCountTotal: 0 }, { abilityType: AbilityType.ALKIMISTA_GYOGYITAL, usageCountTotal: 0 }, { abilityType: AbilityType.ALKIMISTA_SZIKLABOR, usageCountTotal: 0 }], actionDescription: ALKIMISTA_ACTION, effects: [], isAlive: true};
export const DEMOGORGON: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Sejtelmes Sikkasztók/Semleges Gyilkos/Demogorgon_semleges_Gyilkos.png`, faction: Faction.NEUTRAL, character: Character.DEMOGORGON, abilities: [{ abilityType: AbilityType.DEMOGORGON_KILL, usageCountTotal: 0 }], actionDescription: DEMOGORGON_ACTION, effects: [], isAlive: true};
export const DEMONDOSZPOD: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Sejtelmes Sikkasztók/Semleges Gyilkos/DemonikusDoszpod.png`, faction: Faction.NEUTRAL, character: Character.DEMONDOSZPOD, abilities: [{ abilityType: AbilityType.DEMOGORGON_KILL, usageCountTotal: 0 }], actionDescription: DEMON_DOSZPOD, effects: [AbilityType.DEMONDOSZPOD_TULELES], isAlive: true, hasDemonDoszpodAlreadyDiedOnce: false};

// villager
export const BOSSZUALLO: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Bosszúálló/Bosszúálló.png`, faction: Faction.VILLAGER, character: Character.BOSSZUALLO, abilities: [{ abilityType: AbilityType.BOSSZUALLO_KILL, usageCountTotal: 0 }], actionDescription: BOSSZUALLO_ACTION, effects: [], isAlive: true};
export const DOKTOR1: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Ceci Néni-Doktor 1/Ceci_néni_Doktor1.png`, faction: Faction.VILLAGER, character: Character.DOKTOR1, abilities: [{ abilityType: AbilityType.DOKTOR_GYOGYITAS, usageCountTotal: 0 }], actionDescription: DOKTOR_ACTION, effects: [], isAlive: true};
export const DOKTOR2: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Dr. Bubó-Doktor 2/Dr_Bubó_Doktor2.png`, faction: Faction.VILLAGER, character: Character.DOKTOR2, abilities: [{ abilityType: AbilityType.DOKTOR_GYOGYITAS, usageCountTotal: 0 }], actionDescription: DOKTOR_ACTION, effects: [], isAlive: true};
export const DINOIDOMAR: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Dinóidomár-vadász/Dínóidomár_Vadász.png`, faction: Faction.VILLAGER, character: Character.DINOIDOMAR, abilities: [{ abilityType: AbilityType.DINOIDOMAR_KILL, usageCountTotal: 0 }], actionDescription: DINOIDOMAR_ACTION, effects: [], isAlive: true};
export const DETEKTIV1: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Flúgos Monk-Detektív 1/Flugós_Monk_Detektív1.png`, faction: Faction.VILLAGER, character: Character.DETEKTIV1, actionDescription: DETEKTIV_ACTION, effects: [], isAlive: true};
export const DETEKTIV2: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Sherlock-Detektív 2/Sherlock_Detektív2.png`, faction: Faction.VILLAGER, character: Character.DETEKTIV2, actionDescription: DETEKTIV_ACTION, effects: [], isAlive: true};
export const HEGESZTO1: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Hegesztő/Hegesztő.png`, faction: Faction.VILLAGER, character: Character.HEGESZTO1, effects: [], isAlive: true};
export const HEGESZTO2: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Hegesztő/kovácsmester.png`, faction: Faction.VILLAGER, character: Character.HEGESZTO2, effects: [], isAlive: true};
export const PARASZT1: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Paraszt/Paraszt.png`, faction: Faction.VILLAGER, character: Character.PARASZT1, effects: [], isAlive: true};
export const PARASZT2: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Paraszt/Paraszt1.png`, faction: Faction.VILLAGER, character: Character.PARASZT2, effects: [], isAlive: true};
export const SOFOR: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Sofőr/Sofőr.png`, faction: Faction.VILLAGER, character: Character.SOFOR, abilities: [{ abilityType: AbilityType.SOFOR_CSERE, usageCountTotal: 0 }], actionDescription: SOFOR_ACTION, effects: [], isAlive: true};
export const TEKNOS: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Teknős/Teknős.png`, faction: Faction.VILLAGER, character: Character.TEKNOS, abilities: [{ abilityType: AbilityType.TEKNOS_CIGI, usageCountTotal: 0 }], actionDescription: TEKNOS_ACTION, effects: [], isAlive: true};
export const TESTOR1: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Testőr/Testőr1.png`, faction: Faction.VILLAGER, character: Character.TESTOR1, abilities: [{ abilityType: AbilityType.TESTOR_VEDES, usageCountTotal: 0 }], actionDescription: TESTOR_ACTION, effects: [], isAlive: true};
export const TESTOR2: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Testőr/Testőr2.png`, faction: Faction.VILLAGER, character: Character.TESTOR2, abilities: [{ abilityType: AbilityType.TESTOR_VEDES, usageCountTotal: 0 }], actionDescription: TESTOR_ACTION, effects: [], isAlive: true};
