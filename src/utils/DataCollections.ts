...
// villager
export const BOSSZUALLO: CardData = {imageLocation: `${process.env.PUBLIC_URL}/images/Falusi Ficsúrok/Bosszúálló/Bosszúálló.png`, faction: Faction.VILLAGER, character: Character.BOSSZUALLO, abilities: [{ abilityType: AbilityType.BOSSZUALLO_KILL, usageCountTotal: 0 }], actionDescription: BOSSZUALLO_ACTION, effects: [], isAlive: true, isBosszualloKillEnabled: true};
